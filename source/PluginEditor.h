...
public:
    ...
    void setLinearStyle(bool shouldBeLinear);

    juce::Slider slider;
    juce::Label title;

private:
    bool linearStyle = false;
};
...
private:
    ...
    juce::TextButton randomPresetButton, smoothPresetButton, reesePresetButton, wompPresetButton, warhornPresetButton;
