...
juce::AudioProcessorValueTreeState::ParameterLayout FiveParksVST3AudioProcessor::createParameters()
{
    ...
    p.push_back(pf("sub_level", "Sub Level", 0.0f, 1.0f, 0.62f));
    ...
    p.push_back(pf("filter_drive", "Filter Drive", 0.0f, 1.0f, 0.10f));
    ...
    p.push_back(pf("body_amt", "Body", 0.0f, 1.0f, 0.38f));
    p.push_back(pf("growl_amt", "Growl", 0.0f, 1.0f, 0.10f));
    p.push_back(pf("tone_amt", "Tone", 0.0f, 1.0f, 0.28f));
    p.push_back(pf("motion_amt", "Motion", 0.0f, 1.0f, 0.12f));
    ...
    p.push_back(pf("dist_drive", "Dist Drive", 0.0f, 1.0f, 0.14f));
    p.push_back(pf("dist_mix", "Dist Mix", 0.0f, 1.0f, 0.20f));
