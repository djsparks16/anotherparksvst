...
juce::AudioProcessorValueTreeState::ParameterLayout FiveParksVST3AudioProcessor::createParameters()
{
    ...
    p.push_back(pf("oscA_blend", "OSC A Blend", 0.0f, 1.0f, 0.30f));
    ...
    p.push_back(pf("oscA_level", "OSC A Level", 0.0f, 1.0f, 0.72f));
    ...
    p.push_back(pf("oscB_blend", "OSC B Blend", 0.0f, 1.0f, 0.26f));
    ...
    p.push_back(pf("oscB_level", "OSC B Level", 0.0f, 1.0f, 0.56f));
    p.push_back(pf("oscB_pan", "OSC B Pan", 0.0f, 1.0f, 0.5f));

    p.push_back(pc("sub_wave", "Sub Wave", { "Sine","Tri","Saw","Square" }, 0));
    p.push_back(pf("sub_level", "Sub Level", 0.0f, 1.0f, 0.42f));
    ...
    p.push_back(pf("filter_drive", "Filter Drive", 0.0f, 1.0f, 0.04f));
    ...
    p.push_back(pf("reese_amt", "Reese", 0.0f, 1.0f, 0.12f));
    p.push_back(pf("warhorn_amt", "Warhorn", 0.0f, 1.0f, 0.03f));
    p.push_back(pf("womp_amt", "Womp", 0.0f, 1.0f, 0.08f));
    ...
    p.push_back(pf("fm_amt", "FM Grit", 0.0f, 1.0f, 0.015f));
    p.push_back(pf("air_amt", "Air", 0.0f, 1.0f, 0.02f));
    p.push_back(pf("body_amt", "Body", 0.0f, 1.0f, 0.18f));
    p.push_back(pf("growl_amt", "Growl", 0.0f, 1.0f, 0.04f));
    p.push_back(pf("tone_amt", "Tone", 0.0f, 1.0f, 0.16f));
    p.push_back(pf("motion_amt", "Motion", 0.0f, 1.0f, 0.04f));
    p.push_back(pf("screech_amt", "Screech", 0.0f, 1.0f, 0.01f));
    p.push_back(pf("whoop_amt", "Whoop", 0.0f, 1.0f, 0.02f));
    p.push_back(pf("vowel_amt", "Vowel", 0.0f, 1.0f, 0.03f));
    p.push_back(pf("smear_amt", "Smear", 0.0f, 1.0f, 0.02f));
    ...
    p.push_back(pf("dist_drive", "Dist Drive", 0.0f, 1.0f, 0.03f));
    p.push_back(pf("dist_mix", "Dist Mix", 0.0f, 1.0f, 0.08f));
    p.push_back(pf("chorus_mix", "Chorus Mix", 0.0f, 1.0f, 0.08f));
    p.push_back(pf("delay_mix", "Delay Mix", 0.0f, 1.0f, 0.05f));
    p.push_back(pf("reverb_mix", "Reverb Mix", 0.0f, 1.0f, 0.05f));
...
void FiveParksVST3AudioProcessor::processBlock(juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midi)
{
    ...
    {
        // Let voice release tails finish naturally to avoid note-off clicks.
    }
...
namespace
{
    ...
    void setParamChoice(juce::AudioProcessorValueTreeState& apvts, const juce::String& id, int index, int maxIndex)
    {
        setParamNormalized(apvts, id, maxIndex > 0 ? (float) index / (float) maxIndex : 0.0f);
    }
}

void FiveParksVST3AudioProcessor::applyPresetStyle(int index)
{
    if (index == 0)
    {
        setParamChoice(apvts, "bass_mode", 0, 11);
        setParamNormalized(apvts, "dist_drive", 0.02f);
        setParamNormalized(apvts, "dist_mix", 0.04f);
        setParamNormalized(apvts, "reverb_mix", 0.08f);
        setParamNormalized(apvts, "sub_level", 0.35f);
        setParamNormalized(apvts, "noise_level", 0.015f);
        setParamNormalized(apvts, "tone_amt", 0.14f);
        setParamNormalized(apvts, "growl_amt", 0.01f);
        setParamNormalized(apvts, "motion_amt", 0.04f);
        setParamNormalized(apvts, "reese_amt", 0.08f);
    }
    else if (index == 1)
    {
        setParamChoice(apvts, "bass_mode", 1, 11);
        setParamNormalized(apvts, "reese_amt", 0.52f);
        setParamNormalized(apvts, "stereo_width", 0.72f);
        setParamNormalized(apvts, "subharm_amt", 0.26f);
        setParamNormalized(apvts, "chorus_mix", 0.18f);
        setParamNormalized(apvts, "dist_mix", 0.10f);
        setParamNormalized(apvts, "noise_level", 0.02f);
    }
    else if (index == 2)
    {
        setParamChoice(apvts, "bass_mode", 2, 11);
        setParamNormalized(apvts, "womp_amt", 0.58f);
        setParamNormalized(apvts, "motion_amt", 0.38f);
        setParamNormalized(apvts, "filter_cutoff", 0.18f);
        setParamNormalized(apvts, "filter_res", 0.28f);
        setParamNormalized(apvts, "dist_mix", 0.09f);
        setParamNormalized(apvts, "subharm_amt", 0.32f);
    }
    else if (index == 3)
    {
        setParamChoice(apvts, "bass_mode", 4, 11);
        setParamNormalized(apvts, "warhorn_amt", 0.52f);
        setParamNormalized(apvts, "vowel_amt", 0.25f);
        setParamNormalized(apvts, "screech_amt", 0.12f);
        setParamNormalized(apvts, "noise_level", 0.03f);
        setParamNormalized(apvts, "dist_drive", 0.12f);
        setParamNormalized(apvts, "dist_mix", 0.12f);
    }
}

void FiveParksVST3AudioProcessor::randomizePatch()
{
    juce::Random rng;
    auto rf = [&](float a, float b){ return a + (b - a) * rng.nextFloat(); };
    auto setf = [&](const char* id, float a, float b){ setParamNormalized(apvts, id, rf(a, b)); };

    setParamChoice(apvts, "bass_mode", rng.nextInt(12), 11);
    setParamChoice(apvts, "oscA_oct", 4 + rng.nextInt(3) - 1, 8);
    setParamChoice(apvts, "oscB_oct", 4 + rng.nextInt(3) - 1, 8);
    setParamChoice(apvts, "oscA_semi", 12 + rng.nextInt(5) - 2, 24);
    setParamChoice(apvts, "oscB_semi", 12 + rng.nextInt(8) - 4, 24);
    setParamChoice(apvts, "oscA_unison", rng.nextInt(3), 4);
    setParamChoice(apvts, "oscB_unison", rng.nextInt(3), 4);
    setf("oscA_pos", 0.05f, 0.85f);
    setf("oscB_pos", 0.05f, 0.90f);
    setf("oscA_level", 0.28f, 0.78f);
    setf("oscB_level", 0.08f, 0.62f);
    setf("oscA_detune", 0.0f, 0.22f);
    setf("oscB_detune", 0.0f, 0.18f);
    setf("oscA_blend", 0.0f, 0.24f);
    setf("oscB_blend", 0.0f, 0.20f);
    setf("sub_level", 0.10f, 0.62f);
    setf("noise_level", 0.0f, 0.05f);
    setf("filter_cutoff", 0.10f, 0.52f);
    setf("filter_res", 0.08f, 0.35f);
    setf("filter_drive", 0.0f, 0.12f);
    setf("reese_amt", 0.0f, 0.68f);
    setf("warhorn_amt", 0.0f, 0.42f);
    setf("womp_amt", 0.0f, 0.58f);
    setf("subharm_amt", 0.0f, 0.6f);
    setf("combo_amt", 0.0f, 0.28f);
    setf("stereo_width", 0.2f, 0.85f);
    setf("fm_amt", 0.0f, 0.14f);
    setf("air_amt", 0.0f, 0.16f);
    setf("body_amt", 0.0f, 0.75f);
    setf("growl_amt", 0.0f, 0.24f);
    setf("tone_amt", 0.12f, 0.62f);
    setf("motion_amt", 0.0f, 0.32f);
    setf("screech_amt", 0.0f, 0.10f);
    setf("whoop_amt", 0.0f, 0.18f);
    setf("vowel_amt", 0.0f, 0.15f);
    setf("smear_amt", 0.0f, 0.12f);
    setf("env1_a", 0.004f, 0.030f);
    setf("env1_d", 0.10f, 0.45f);
    setf("env1_s", 0.45f, 0.9f);
    setf("env1_r", 0.08f, 0.30f);
    setf("lfo1_rate", 0.04f, 0.22f);
    setf("lfo1_amt", 0.0f, 0.35f);
    setf("lfo1_shape", 0.0f, 1.0f);
    setf("lfo1_smooth", 0.05f, 0.35f);
    setf("dist_drive", 0.0f, 0.08f);
    setf("dist_mix", 0.0f, 0.10f);
    setf("chorus_mix", 0.0f, 0.14f);
    setf("delay_mix", 0.0f, 0.08f);
    setf("reverb_mix", 0.0f, 0.08f);
}
